...
Ogni label (`home:…`, `overlay:…`, …) è uno **step sequenziale o parallelo** misurato nel log della **stessa** Function; così nei **Runtime logs** vedi dove si accumula tempo prima del timeout ~10s (Hobby).
